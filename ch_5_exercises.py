...
def joke():
    print("Is your refrigerator running?")
...
def line_four():
    print("Little old lady who?")


def line_five():
    print("Wow, I didn't know you could yodel!")
...
def get_name():
    ...
    print(f"Hello, {user_name}")  # print("Hello,", user_name)
...
def main6():
    ...
    print(f"Your BMI is {answer: .1f}.")  # print("Your BMI is", format(answer, '.1f"))
...
print(f"The ceiling for {number_to_round} is {math.ceil(number_to_round)}.")